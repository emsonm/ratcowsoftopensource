...
namespace sharppunk.graphics
{
    public class Tilemap : Graphic
    {
        ...
        public Tilemap(Bitmap tileset, uint width, uint height, int tileWidth, int tileHeight)
        {
        ...
        override public void Render(System.Drawing.Graphics target, Vector2 point, Vector2 camera)
        {
