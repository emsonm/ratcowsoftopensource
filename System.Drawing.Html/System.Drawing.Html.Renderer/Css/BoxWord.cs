        ...
        : Rectangle
    {
        ...
        public Image Image
        {
            ...
            { 
                ...
                if (value != null)
                {
                    ElementLength w = new ElementLength(OwnerBox.Width);
                    ElementLength h = new ElementLength(OwnerBox.Height);
                    if (w.Number > 0 && w.Unit == ElementLength.CssUnit.Pixels)
                    {
                        Width = w.Number;
                    }
                    else
                    ...
                    if (h.Number > 0 && h.Unit == ElementLength.CssUnit.Pixels)
                    {
