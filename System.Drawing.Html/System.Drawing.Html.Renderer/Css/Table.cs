...
namespace System.Drawing.Html.Renderer.Css
{
    internal class Table
    {
        ...
        private Box _tableBox;
        private int _rowCount;
        private int _columnCount;
        private List<Box> _bodyrows;
        private Box _caption;
        private List<Box> _columns;
        private Box _headerBox;
        private Box _footerBox;
        private List<Box> _allRows;
        ...
        private Table()
        {
            _bodyrows = new List<Box>();
            _columns = new List<Box>();
            _allRows = new List<Box>();
        }

        public Table(Box tableBox, IGraphics g)
            :this()
        {
        ...
        /// <returns></returns>
        private float GetSpannedMinWidth(Box row, Box cell, int realcolindex, int colspan)
        {
            float w = 0f;
        ...
        /// <param name="b"></param>
        /// <param name="g"></param>
        private void Measure(Box b, IGraphics g)
        {
            if (b == null) return;
        ...
        /// <param name="b"></param>
        /// <param name="g"></param>
        private void MeasureWords(Box b, IGraphics g)
        {
            if (b == null) return;
        ...
        {
            float f = Value.ParseNumber(b.GetAttribute("span"), 1);
