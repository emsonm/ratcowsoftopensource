...
{
	public class RadioButtonTemplate : BaseTemplate
	{
		...
		{
			XmlElement xmlElement = document.CreateElement("RadioButton");
			...
			xmlElement.SetAttribute("Content", base.Control.Text);
			return xmlElement;
		}
	}
}