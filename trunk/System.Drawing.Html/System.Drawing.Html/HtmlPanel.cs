...
namespace System.Windows.Forms
{
  ...
  using System.Drawing.Html.Renderer.Css;
      ...
      : ScrollableControl
  {
    ...
    protected override void OnPaint( PaintEventArgs e )
    {
      ...
      _htmlContainer.Paint( new GraphicsWrapper( e.Graphics ) );
    ...
    protected override void OnMouseMove( MouseEventArgs e )
    {
      ...
      foreach ( Box box in _htmlContainer.LinkRegions.Keys )
      {
        RectangleF rect = _htmlContainer.LinkRegions[ box ];
        if ( SWF.Rectangle.Round( rect ).Contains( e.X, e.Y ) )
        {
          Cursor = Cursors.Hand;
          return;
        }
