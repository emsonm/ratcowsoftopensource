...
namespace System.Drawing.Html.Renderer.Css
{
    ...
    public class Block
    {
        ...
        public Block(string blockSource)
            : this()
        {
            _block = blockSource;
            ...
            foreach (Match match in matches)
            {
                ...
                if (Box._properties.ContainsKey(propName))
                    PropertyValues.Add(Box._properties[propName], propValue);
            }
        }
        ...
        internal void UpdatePropertyValues()
        {
            ...
            {
                if (Box._properties.ContainsKey(prop))
                    PropertyValues.Add(Box._properties[prop], Properties[prop]);
            }
        }
